...
var VALID_IMAGERY_SETS = ['Aerial', 'AerialWithLabels', 'Road', 'RoadOnDemand', 'CanvasLight', 'CanvasDark', 'CanvasGray', 'OrdnanceSurvey'];
...
L.TileLayer.Bing = L.TileLayer.extend({
  ...
  initialize: function initialize(options) {
    ...
    this._fetch = fetchJsonp(metaDataUrl, { jsonpCallback: 'jsonp' }).then(function (response) {
   ...
   */
  getMetaData: function getMetaData(latlng, zoom) {
    ...
    return fetchJsonp(PointMetaDataUrl, { jsonpCallback: 'jsonp' }).then(function (response) {
      return response.json();
   ...
   */
  _getAttributions: function _getAttributions(bbox, zoom) {
...
},{"bbox-intersect":2,"fetch-jsonp/src/fetch-jsonp":3}],2:[function(require,module,exports){
"use strict";

module.exports = function (bbox1, bbox2) {
  if (!(bbox1[0] > bbox2[2] || bbox1[2] < bbox2[0] || bbox1[3] < bbox2[1] || bbox1[1] > bbox2[3])) {
    return true;
  } else {
    return false;
  }
